...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * To give order summary.
     *
     * @param price is the price of the order given.
     * @return order summary.
     */
    private String createOrderSummary(String name, int price, boolean addChocolate, boolean addWhippedCream) {
        String chocolate;
        ...
        priceMessage += "\n"+ getString(R.string.order_summary_whipped_cream,whipped_cream);
    ...
    public void increment(View view) {
        if (quantity == 10) {
            ...
            //Exit this method early as there is no thing left to do.
            return;
        }
        quantity = quantity + 1;
